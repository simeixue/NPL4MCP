# file: /Users/xue/workspace/mcp_project/mcp_server_pyrepos/ProxmoxMCP/src/proxmox_mcp/config/loader.py
# module: src.proxmox_mcp.config.loader
# qname: src.proxmox_mcp.config.loader.load_config
# lines: 18-74
